...
- [x] 2026-04-04 LINE OA 搬遷：將 `src/channels/line/official/` 核心邏輯移至 `/data/personal/line-official/`，switchboard 保留薄 adapter
      執行：複製所有 .py、建立 pyproject.toml、.agent/、README.md、AGENT_PLAN.md、git init
      驗證：`/data/personal/line-official/` 已 git init，first commit 包含 20 個檔案
